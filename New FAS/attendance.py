...
class Attendance:
    ...
    def __init__(self,root):
        self.root=root
        self.root.geometry("700x600+50+100")
        ...
        main_frame.place(x=5,y=20,width=680,height=569)

        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text=" Student Attendance Details ",font=("Helvetica",12,"bold"),fg="navyblue")
        ...
        table_frame.place(x=10,y=145,width=635,height=310)
        ...
        #create table 
        self.attendanceReport_left = ttk.Treeview(table_frame,column=("Name","Roll_No", "ID","Semester","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
